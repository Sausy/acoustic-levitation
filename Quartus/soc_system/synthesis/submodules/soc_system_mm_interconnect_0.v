...
module soc_system_mm_interconnect_0 (
		...
		input  wire        fpga_key_reset_reset_bridge_in_reset_reset,                          //                          fpga_key_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  fpga_key_s1_address,                                                 //                                                   fpga_key_s1.address
		output wire        fpga_key_s1_write,                                                   //                                                              .write
		input  wire [31:0] fpga_key_s1_readdata,                                                //                                                              .readdata
		output wire [31:0] fpga_key_s1_writedata,                                               //                                                              .writedata
		output wire        fpga_key_s1_chipselect,                                              //                                                              .chipselect
		output wire [2:0]  fpga_led_s1_address,                                                 //                                                   fpga_led_s1.address
		output wire        fpga_led_s1_write,                                                   //                                                              .write
		input  wire [31:0] fpga_led_s1_readdata,                                                //                                                              .readdata
		output wire [31:0] fpga_led_s1_writedata,                                               //                                                              .writedata
		output wire        fpga_led_s1_chipselect,                                              //                                                              .chipselect
	...
	wire   [31:0] fpga_key_s1_agent_m0_readdata;                             // fpga_key_s1_translator:uav_readdata -> fpga_key_s1_agent:m0_readdata
	wire          fpga_key_s1_agent_m0_waitrequest;                          // fpga_key_s1_translator:uav_waitrequest -> fpga_key_s1_agent:m0_waitrequest
	wire          fpga_key_s1_agent_m0_debugaccess;                          // fpga_key_s1_agent:m0_debugaccess -> fpga_key_s1_translator:uav_debugaccess
	wire   [20:0] fpga_key_s1_agent_m0_address;                              // fpga_key_s1_agent:m0_address -> fpga_key_s1_translator:uav_address
	wire    [3:0] fpga_key_s1_agent_m0_byteenable;                           // fpga_key_s1_agent:m0_byteenable -> fpga_key_s1_translator:uav_byteenable
	wire          fpga_key_s1_agent_m0_read;                                 // fpga_key_s1_agent:m0_read -> fpga_key_s1_translator:uav_read
	wire          fpga_key_s1_agent_m0_readdatavalid;                        // fpga_key_s1_translator:uav_readdatavalid -> fpga_key_s1_agent:m0_readdatavalid
	wire          fpga_key_s1_agent_m0_lock;                                 // fpga_key_s1_agent:m0_lock -> fpga_key_s1_translator:uav_lock
	wire   [31:0] fpga_key_s1_agent_m0_writedata;                            // fpga_key_s1_agent:m0_writedata -> fpga_key_s1_translator:uav_writedata
	wire          fpga_key_s1_agent_m0_write;                                // fpga_key_s1_agent:m0_write -> fpga_key_s1_translator:uav_write
	wire    [2:0] fpga_key_s1_agent_m0_burstcount;                           // fpga_key_s1_agent:m0_burstcount -> fpga_key_s1_translator:uav_burstcount
	wire          fpga_key_s1_agent_rf_source_valid;                         // fpga_key_s1_agent:rf_source_valid -> fpga_key_s1_agent_rsp_fifo:in_valid
	wire  [114:0] fpga_key_s1_agent_rf_source_data;                          // fpga_key_s1_agent:rf_source_data -> fpga_key_s1_agent_rsp_fifo:in_data
	wire          fpga_key_s1_agent_rf_source_ready;                         // fpga_key_s1_agent_rsp_fifo:in_ready -> fpga_key_s1_agent:rf_source_ready
	wire          fpga_key_s1_agent_rf_source_startofpacket;                 // fpga_key_s1_agent:rf_source_startofpacket -> fpga_key_s1_agent_rsp_fifo:in_startofpacket
	wire          fpga_key_s1_agent_rf_source_endofpacket;                   // fpga_key_s1_agent:rf_source_endofpacket -> fpga_key_s1_agent_rsp_fifo:in_endofpacket
	wire          fpga_key_s1_agent_rsp_fifo_out_valid;                      // fpga_key_s1_agent_rsp_fifo:out_valid -> fpga_key_s1_agent:rf_sink_valid
	wire  [114:0] fpga_key_s1_agent_rsp_fifo_out_data;                       // fpga_key_s1_agent_rsp_fifo:out_data -> fpga_key_s1_agent:rf_sink_data
	wire          fpga_key_s1_agent_rsp_fifo_out_ready;                      // fpga_key_s1_agent:rf_sink_ready -> fpga_key_s1_agent_rsp_fifo:out_ready
	wire          fpga_key_s1_agent_rsp_fifo_out_startofpacket;              // fpga_key_s1_agent_rsp_fifo:out_startofpacket -> fpga_key_s1_agent:rf_sink_startofpacket
	wire          fpga_key_s1_agent_rsp_fifo_out_endofpacket;                // fpga_key_s1_agent_rsp_fifo:out_endofpacket -> fpga_key_s1_agent:rf_sink_endofpacket
	wire          fpga_key_s1_agent_rdata_fifo_src_valid;                    // fpga_key_s1_agent:rdata_fifo_src_valid -> fpga_key_s1_agent_rdata_fifo:in_valid
	wire   [33:0] fpga_key_s1_agent_rdata_fifo_src_data;                     // fpga_key_s1_agent:rdata_fifo_src_data -> fpga_key_s1_agent_rdata_fifo:in_data
	wire          fpga_key_s1_agent_rdata_fifo_src_ready;                    // fpga_key_s1_agent_rdata_fifo:in_ready -> fpga_key_s1_agent:rdata_fifo_src_ready
	wire   [31:0] fpga_led_s1_agent_m0_readdata;                             // fpga_led_s1_translator:uav_readdata -> fpga_led_s1_agent:m0_readdata
	wire          fpga_led_s1_agent_m0_waitrequest;                          // fpga_led_s1_translator:uav_waitrequest -> fpga_led_s1_agent:m0_waitrequest
	wire          fpga_led_s1_agent_m0_debugaccess;                          // fpga_led_s1_agent:m0_debugaccess -> fpga_led_s1_translator:uav_debugaccess
	wire   [20:0] fpga_led_s1_agent_m0_address;                              // fpga_led_s1_agent:m0_address -> fpga_led_s1_translator:uav_address
	wire    [3:0] fpga_led_s1_agent_m0_byteenable;                           // fpga_led_s1_agent:m0_byteenable -> fpga_led_s1_translator:uav_byteenable
	wire          fpga_led_s1_agent_m0_read;                                 // fpga_led_s1_agent:m0_read -> fpga_led_s1_translator:uav_read
	wire          fpga_led_s1_agent_m0_readdatavalid;                        // fpga_led_s1_translator:uav_readdatavalid -> fpga_led_s1_agent:m0_readdatavalid
	wire          fpga_led_s1_agent_m0_lock;                                 // fpga_led_s1_agent:m0_lock -> fpga_led_s1_translator:uav_lock
	wire   [31:0] fpga_led_s1_agent_m0_writedata;                            // fpga_led_s1_agent:m0_writedata -> fpga_led_s1_translator:uav_writedata
	wire          fpga_led_s1_agent_m0_write;                                // fpga_led_s1_agent:m0_write -> fpga_led_s1_translator:uav_write
	wire    [2:0] fpga_led_s1_agent_m0_burstcount;                           // fpga_led_s1_agent:m0_burstcount -> fpga_led_s1_translator:uav_burstcount
	wire          fpga_led_s1_agent_rf_source_valid;                         // fpga_led_s1_agent:rf_source_valid -> fpga_led_s1_agent_rsp_fifo:in_valid
	wire  [114:0] fpga_led_s1_agent_rf_source_data;                          // fpga_led_s1_agent:rf_source_data -> fpga_led_s1_agent_rsp_fifo:in_data
	wire          fpga_led_s1_agent_rf_source_ready;                         // fpga_led_s1_agent_rsp_fifo:in_ready -> fpga_led_s1_agent:rf_source_ready
	wire          fpga_led_s1_agent_rf_source_startofpacket;                 // fpga_led_s1_agent:rf_source_startofpacket -> fpga_led_s1_agent_rsp_fifo:in_startofpacket
	wire          fpga_led_s1_agent_rf_source_endofpacket;                   // fpga_led_s1_agent:rf_source_endofpacket -> fpga_led_s1_agent_rsp_fifo:in_endofpacket
	wire          fpga_led_s1_agent_rsp_fifo_out_valid;                      // fpga_led_s1_agent_rsp_fifo:out_valid -> fpga_led_s1_agent:rf_sink_valid
	wire  [114:0] fpga_led_s1_agent_rsp_fifo_out_data;                       // fpga_led_s1_agent_rsp_fifo:out_data -> fpga_led_s1_agent:rf_sink_data
	wire          fpga_led_s1_agent_rsp_fifo_out_ready;                      // fpga_led_s1_agent:rf_sink_ready -> fpga_led_s1_agent_rsp_fifo:out_ready
	wire          fpga_led_s1_agent_rsp_fifo_out_startofpacket;              // fpga_led_s1_agent_rsp_fifo:out_startofpacket -> fpga_led_s1_agent:rf_sink_startofpacket
	wire          fpga_led_s1_agent_rsp_fifo_out_endofpacket;                // fpga_led_s1_agent_rsp_fifo:out_endofpacket -> fpga_led_s1_agent:rf_sink_endofpacket
	wire          fpga_led_s1_agent_rdata_fifo_src_valid;                    // fpga_led_s1_agent:rdata_fifo_src_valid -> fpga_led_s1_agent_rdata_fifo:in_valid
	wire   [33:0] fpga_led_s1_agent_rdata_fifo_src_data;                     // fpga_led_s1_agent:rdata_fifo_src_data -> fpga_led_s1_agent_rdata_fifo:in_data
	wire          fpga_led_s1_agent_rdata_fifo_src_ready;                    // fpga_led_s1_agent_rdata_fifo:in_ready -> fpga_led_s1_agent:rdata_fifo_src_ready
	...
	wire   [20:0] piezo_controller_0_s1_agent_m0_address;                    // piezo_controller_0_s1_agent:m0_address -> piezo_controller_0_s1_translator:uav_address
	...
	wire   [96:0] piezo_controller_0_s1_agent_rf_source_data;                // piezo_controller_0_s1_agent:rf_source_data -> piezo_controller_0_s1_agent_rsp_fifo:in_data
	...
	wire   [96:0] piezo_controller_0_s1_agent_rsp_fifo_out_data;             // piezo_controller_0_s1_agent_rsp_fifo:out_data -> piezo_controller_0_s1_agent:rf_sink_data
	...
	wire          piezo_controller_0_s1_agent_rdata_fifo_src_valid;          // piezo_controller_0_s1_agent:rdata_fifo_src_valid -> piezo_controller_0_s1_agent_rdata_fifo:in_valid
	wire   [17:0] piezo_controller_0_s1_agent_rdata_fifo_src_data;           // piezo_controller_0_s1_agent:rdata_fifo_src_data -> piezo_controller_0_s1_agent_rdata_fifo:in_data
	wire          piezo_controller_0_s1_agent_rdata_fifo_src_ready;          // piezo_controller_0_s1_agent_rdata_fifo:in_ready -> piezo_controller_0_s1_agent:rdata_fifo_src_ready
	...
	wire          fpga_key_s1_agent_rp_valid;                                // fpga_key_s1_agent:rp_valid -> router_002:sink_valid
	wire  [113:0] fpga_key_s1_agent_rp_data;                                 // fpga_key_s1_agent:rp_data -> router_002:sink_data
	wire          fpga_key_s1_agent_rp_ready;                                // router_002:sink_ready -> fpga_key_s1_agent:rp_ready
	wire          fpga_key_s1_agent_rp_startofpacket;                        // fpga_key_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          fpga_key_s1_agent_rp_endofpacket;                          // fpga_key_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          fpga_led_s1_agent_rp_valid;                                // fpga_led_s1_agent:rp_valid -> router_003:sink_valid
	wire  [113:0] fpga_led_s1_agent_rp_data;                                 // fpga_led_s1_agent:rp_data -> router_003:sink_data
	wire          fpga_led_s1_agent_rp_ready;                                // router_003:sink_ready -> fpga_led_s1_agent:rp_ready
	wire          fpga_led_s1_agent_rp_startofpacket;                        // fpga_led_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          fpga_led_s1_agent_rp_endofpacket;                          // fpga_led_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire   [95:0] piezo_controller_0_s1_agent_rp_data;                       // piezo_controller_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire          cmd_mux_src_valid;                                         // cmd_mux:src_valid -> fpga_key_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_src_data;                                          // cmd_mux:src_data -> fpga_key_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                         // fpga_key_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                       // cmd_mux:src_channel -> fpga_key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                 // cmd_mux:src_startofpacket -> fpga_key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                   // cmd_mux:src_endofpacket -> fpga_key_s1_burst_adapter:sink0_endofpacket
	wire          fpga_key_s1_burst_adapter_source0_valid;                   // fpga_key_s1_burst_adapter:source0_valid -> fpga_key_s1_agent:cp_valid
	wire  [113:0] fpga_key_s1_burst_adapter_source0_data;                    // fpga_key_s1_burst_adapter:source0_data -> fpga_key_s1_agent:cp_data
	wire          fpga_key_s1_burst_adapter_source0_ready;                   // fpga_key_s1_agent:cp_ready -> fpga_key_s1_burst_adapter:source0_ready
	wire    [2:0] fpga_key_s1_burst_adapter_source0_channel;                 // fpga_key_s1_burst_adapter:source0_channel -> fpga_key_s1_agent:cp_channel
	wire          fpga_key_s1_burst_adapter_source0_startofpacket;           // fpga_key_s1_burst_adapter:source0_startofpacket -> fpga_key_s1_agent:cp_startofpacket
	wire          fpga_key_s1_burst_adapter_source0_endofpacket;             // fpga_key_s1_burst_adapter:source0_endofpacket -> fpga_key_s1_agent:cp_endofpacket
	wire          cmd_mux_001_src_valid;                                     // cmd_mux_001:src_valid -> fpga_led_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_001_src_data;                                      // cmd_mux_001:src_data -> fpga_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                     // fpga_led_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                   // cmd_mux_001:src_channel -> fpga_led_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                             // cmd_mux_001:src_startofpacket -> fpga_led_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                               // cmd_mux_001:src_endofpacket -> fpga_led_s1_burst_adapter:sink0_endofpacket
	wire          fpga_led_s1_burst_adapter_source0_valid;                   // fpga_led_s1_burst_adapter:source0_valid -> fpga_led_s1_agent:cp_valid
	wire  [113:0] fpga_led_s1_burst_adapter_source0_data;                    // fpga_led_s1_burst_adapter:source0_data -> fpga_led_s1_agent:cp_data
	wire          fpga_led_s1_burst_adapter_source0_ready;                   // fpga_led_s1_agent:cp_ready -> fpga_led_s1_burst_adapter:source0_ready
	wire    [2:0] fpga_led_s1_burst_adapter_source0_channel;                 // fpga_led_s1_burst_adapter:source0_channel -> fpga_led_s1_agent:cp_channel
	wire          fpga_led_s1_burst_adapter_source0_startofpacket;           // fpga_led_s1_burst_adapter:source0_startofpacket -> fpga_led_s1_agent:cp_startofpacket
	wire          fpga_led_s1_burst_adapter_source0_endofpacket;             // fpga_led_s1_burst_adapter:source0_endofpacket -> fpga_led_s1_agent:cp_endofpacket
	...
	wire   [95:0] piezo_controller_0_s1_burst_adapter_source0_data;          // piezo_controller_0_s1_burst_adapter:source0_data -> piezo_controller_0_s1_agent:cp_data
	...
	wire    [2:0] piezo_controller_0_s1_burst_adapter_source0_channel;       // piezo_controller_0_s1_burst_adapter:source0_channel -> piezo_controller_0_s1_agent:cp_channel
	...
	wire   [95:0] router_004_src_data;                                       // router_004:src_data -> piezo_controller_0_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                      // piezo_controller_0_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [2:0] router_004_src_channel;                                    // router_004:src_channel -> piezo_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire          piezo_controller_0_s1_rsp_width_adapter_src_valid;         // piezo_controller_0_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [113:0] piezo_controller_0_s1_rsp_width_adapter_src_data;          // piezo_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          piezo_controller_0_s1_rsp_width_adapter_src_ready;         // rsp_demux_002:sink_ready -> piezo_controller_0_s1_rsp_width_adapter:out_ready
	wire    [2:0] piezo_controller_0_s1_rsp_width_adapter_src_channel;       // piezo_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          piezo_controller_0_s1_rsp_width_adapter_src_startofpacket; // piezo_controller_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          piezo_controller_0_s1_rsp_width_adapter_src_endofpacket;   // piezo_controller_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          cmd_mux_002_src_valid;                                     // cmd_mux_002:src_valid -> piezo_controller_0_s1_cmd_width_adapter:in_valid
	wire  [113:0] cmd_mux_002_src_data;                                      // cmd_mux_002:src_data -> piezo_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                     // piezo_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                   // cmd_mux_002:src_channel -> piezo_controller_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                             // cmd_mux_002:src_startofpacket -> piezo_controller_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                               // cmd_mux_002:src_endofpacket -> piezo_controller_0_s1_cmd_width_adapter:in_endofpacket
	...
	wire   [95:0] piezo_controller_0_s1_cmd_width_adapter_src_data;          // piezo_controller_0_s1_cmd_width_adapter:out_data -> piezo_controller_0_s1_burst_adapter:sink0_data
	...
	wire    [2:0] piezo_controller_0_s1_cmd_width_adapter_src_channel;       // piezo_controller_0_s1_cmd_width_adapter:out_channel -> piezo_controller_0_s1_burst_adapter:sink0_channel
	...
	wire          fpga_key_s1_agent_rdata_fifo_out_valid;                    // fpga_key_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] fpga_key_s1_agent_rdata_fifo_out_data;                     // fpga_key_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          fpga_key_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter:in_0_ready -> fpga_key_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                             // avalon_st_adapter:out_0_valid -> fpga_key_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                              // avalon_st_adapter:out_0_data -> fpga_key_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                             // fpga_key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                             // avalon_st_adapter:out_0_error -> fpga_key_s1_agent:rdata_fifo_sink_error
	wire          fpga_led_s1_agent_rdata_fifo_out_valid;                    // fpga_led_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fpga_led_s1_agent_rdata_fifo_out_data;                     // fpga_led_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          fpga_led_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_001:in_0_ready -> fpga_led_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                         // avalon_st_adapter_001:out_0_valid -> fpga_led_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                          // avalon_st_adapter_001:out_0_data -> fpga_led_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                         // fpga_led_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                         // avalon_st_adapter_001:out_0_error -> fpga_led_s1_agent:rdata_fifo_sink_error
	wire          piezo_controller_0_s1_agent_rdata_fifo_out_valid;          // piezo_controller_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [17:0] piezo_controller_0_s1_agent_rdata_fifo_out_data;           // piezo_controller_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          piezo_controller_0_s1_agent_rdata_fifo_out_ready;          // avalon_st_adapter_002:in_0_ready -> piezo_controller_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                         // avalon_st_adapter_002:out_0_valid -> piezo_controller_0_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_002_out_0_data;                          // avalon_st_adapter_002:out_0_data -> piezo_controller_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                         // piezo_controller_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                         // avalon_st_adapter_002:out_0_error -> piezo_controller_0_s1_agent:rdata_fifo_sink_error
	...
	) fpga_key_s1_translator (
		.clk                    (clk_0_clk_clk),                              //                      clk.clk
		.reset                  (fpga_key_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fpga_key_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (fpga_key_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (fpga_key_s1_agent_m0_read),                  //                         .read
		.uav_write              (fpga_key_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (fpga_key_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (fpga_key_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (fpga_key_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (fpga_key_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (fpga_key_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (fpga_key_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (fpga_key_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (fpga_key_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (fpga_key_s1_write),                          //                         .write
		.av_readdata            (fpga_key_s1_readdata),                       //                         .readdata
		.av_writedata           (fpga_key_s1_writedata),                      //                         .writedata
		.av_chipselect          (fpga_key_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                           //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) fpga_led_s1_translator (
		.clk                    (clk_0_clk_clk),                              //                      clk.clk
		.reset                  (fpga_key_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (fpga_led_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (fpga_led_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (fpga_led_s1_agent_m0_read),                  //                         .read
		.uav_write              (fpga_led_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (fpga_led_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (fpga_led_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (fpga_led_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (fpga_led_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (fpga_led_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (fpga_led_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (fpga_led_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (fpga_led_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (fpga_led_s1_write),                          //                         .write
		.av_readdata            (fpga_led_s1_readdata),                       //                         .readdata
		.av_writedata           (fpga_led_s1_writedata),                      //                         .writedata
		.av_chipselect          (fpga_led_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                           //              (terminated)
		.av_begintransfer       (),                                           //              (terminated)
		.av_beginbursttransfer  (),                                           //              (terminated)
		.av_burstcount          (),                                           //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (fpga_key_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (fpga_key_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fpga_key_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fpga_key_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fpga_key_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fpga_key_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (fpga_key_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fpga_key_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fpga_key_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (fpga_key_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fpga_key_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (fpga_key_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (fpga_key_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fpga_key_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (fpga_key_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (fpga_key_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (fpga_key_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fpga_key_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fpga_key_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fpga_key_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fpga_key_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fpga_key_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fpga_key_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fpga_key_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fpga_key_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fpga_key_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fpga_key_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fpga_key_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fpga_key_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fpga_key_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fpga_key_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fpga_key_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fpga_key_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (fpga_key_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fpga_key_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fpga_key_s1_agent_rdata_fifo_src_data),           //                .data
	...
	) fpga_key_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (fpga_key_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (fpga_key_s1_agent_rf_source_data),             //        in.data
		.in_valid          (fpga_key_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (fpga_key_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fpga_key_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fpga_key_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fpga_key_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fpga_key_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fpga_key_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fpga_key_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fpga_key_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fpga_key_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (fpga_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fpga_key_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (fpga_key_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (fpga_key_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (fpga_key_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (fpga_key_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (fpga_key_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (fpga_key_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (fpga_led_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (fpga_led_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (fpga_led_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (fpga_led_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (fpga_led_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (fpga_led_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (fpga_led_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (fpga_led_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (fpga_led_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (fpga_led_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (fpga_led_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (fpga_led_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (fpga_led_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (fpga_led_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (fpga_led_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (fpga_led_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (fpga_led_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fpga_led_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fpga_led_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fpga_led_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fpga_led_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fpga_led_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (fpga_led_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (fpga_led_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (fpga_led_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (fpga_led_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (fpga_led_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (fpga_led_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (fpga_led_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (fpga_led_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (fpga_led_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (fpga_led_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),               //                .error
		.rdata_fifo_src_ready    (fpga_led_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (fpga_led_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (fpga_led_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fpga_led_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (fpga_key_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (fpga_led_s1_agent_rf_source_data),             //        in.data
		.in_valid          (fpga_led_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (fpga_led_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (fpga_led_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (fpga_led_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (fpga_led_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (fpga_led_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (fpga_led_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (fpga_led_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (fpga_led_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fpga_led_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (fpga_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fpga_led_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (fpga_led_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (fpga_led_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (fpga_led_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (fpga_led_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (fpga_led_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) piezo_controller_0_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (fpga_key_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (piezo_controller_0_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (piezo_controller_0_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (piezo_controller_0_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (piezo_controller_0_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (piezo_controller_0_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (piezo_controller_0_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	soc_system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (fpga_key_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (fpga_key_s1_agent_rp_valid),                 //          .valid
		.sink_data          (fpga_key_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (fpga_key_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (fpga_key_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (fpga_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (fpga_led_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (fpga_led_s1_agent_rp_valid),                 //          .valid
		.sink_data          (fpga_led_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (fpga_led_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (fpga_led_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (fpga_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
	...
	) fpga_key_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                   //       cr0.clk
		.reset                 (fpga_key_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		...
		.source0_valid         (fpga_key_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fpga_key_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (fpga_key_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fpga_key_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fpga_key_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fpga_key_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (fpga_led_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fpga_led_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (fpga_led_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fpga_led_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fpga_led_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fpga_led_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (fpga_key_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fpga_key_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (fpga_key_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (fpga_key_s1_agent_rdata_fifo_out_ready),     //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (fpga_key_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fpga_led_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (fpga_led_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (fpga_led_s1_agent_rdata_fifo_out_ready),     //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (fpga_key_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (piezo_controller_0_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (piezo_controller_0_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (piezo_controller_0_s1_agent_rdata_fifo_out_ready), //         .ready
